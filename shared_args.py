...
def add_shared_args():
    ...
    parser.add_argument('--config', type=str, default = 'latent-diffusion/configs/latent-diffusion/cin-ldm-vq-f8.yaml', help='diffusion model config')
    parser.add_argument('--ckpt', type=str, help='diffusion model ckpt')
    parser.add_argument('--embed_dim', type=int, default=512, help='class embed dim')
    parser.add_argument('--dataset', type=str, default='imagenet-fruits', help='dataset')
    ...
    parser.add_argument('--res', type=int, default=256, choices=[128, 256, 512], help='resolution')
